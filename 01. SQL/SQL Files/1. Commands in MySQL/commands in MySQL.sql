...
i) DDL is a SQL Commands tot define the database schema
...
show databases;
drop database imarticus_learning;
...
insert into students_info (last_name,first_name,gender) values ('Gowda','dinesh',"M");           
...
-- Deleting those information where Date of birth is null
Delete from students_info where Date_of_Birth is null;
